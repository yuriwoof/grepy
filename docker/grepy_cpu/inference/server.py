...
def initialize():
    ...
    return classifier,categories,center_only,num_of_result 
...
def classify():
    if request.method == 'POST':
        ...
        # TODO: this process should be called at onece at starting flask process
        classifier,categories,center_only,num_of_result = initialize()
